...
<section class="edit-phone">
	<article class="edit-number"><input class="co_name" value="<?php echo $userinfo['qq']?>"/><img src="/weixin/skin/images/dele.png"/></article>
...
//			}
			...
			$.post("/wechat.php/user/editInfo",{"qq":co_name,"co_name":co_name,"co_address":1,"type":type},function(data){
				data = eval('(' + data + ')');
				if(data["code"] == 0){
					alert(data["info"]);
