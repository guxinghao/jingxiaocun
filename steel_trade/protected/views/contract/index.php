<div class="con_tit">
	...
	<div class="con_tit_cz">
		<a href="<?php echo Yii::app()->createUrl('contract/create',array('fpage'=>$_REQUEST['page']))?>">
		<button type="button" class="btn btn-primary btn-sm create_btn" data-dismiss="modal">新建合同</button>
		</a>
<!-- 		<button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">先销先进</button> -->
<!-- 		<button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">代销采购</button> -->
	</div>
</div>
<style>
.submit_form{
...
<form method="post" action="/index.php/contract/index?page=1">
<div class="search_body">
	<div class="srarch_box">
		<img src="<?php echo imgUrl('search.png');?>">
		<input placeholder="请输入单号或合同号" id="srarch" class="forreset" value="<?php echo $search['keywords']?>" name="search[keywords]">
	</div>
...
<!-- 		<div class="more_one_l">供应商：</div> -->
		...
		<div class="more_one_l" style="width: 80px;">供应商：</div>
		<div id="wareselect" class="fa_droplist">
			<input type="text" class="forreset" id="combo" value="<?php echo DictCompany::getName($search['vendor']);?>" />
 ...
 <script type="text/javascript">
  $(function(){
     $('#datatable1').datatable({
    	 fixedLeftWidth:<?php echo  $search['form_status']=='delete'?28:330;?>,
    	 fixedRightWidth:0,
      });
   });
  </script>
...
<?php paginate($pages, "contract_list")?>
...
<script>
	    ...
	    $(function(){
		    ...
		    $('.create_btn').click(function(e){
				var result=checkAuthority('采购合同:新增');
				if(result=='no')
				{
// 					alert('您没有权限执行此操作');
					e.preventDefault();
