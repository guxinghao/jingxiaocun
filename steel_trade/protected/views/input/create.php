...
<div class="shop_select_box">
	<div class="shop_more_one">
		...
		<input type="hidden"  name="FrmInput[from]" value="purchase" id="from">
...
<input type="hidden" id="tr_num" value="1">
    ...
    <tbody class="forinsert" id="forinsert">
    	...
    	<tr class="<?php echo $i%2==0?"selected":""?>">
			...
			<td>
				<input type="text"  name="" readonly style="" value="<?php echo $data->amount-$data->input_amount;?>" class="form-control  "  >
			</td>			
    		<td >
    			<input type="text"  name="td_amount[]" style="" value="<?php echo $data->amount-$data->input_amount;?>" class="form-control td_amount td_num"  >
    			<input type="hidden"   value="<?php echo $data->amount-$data->input_amount;?>" class="form-control  td_max_num"  >
    		</td>
    		<td >
    		...
    		<td ><input type="text"  readonly name="td_price[]" style="" value="<?php echo $data->price;?>" class="form-control td_price" ></td>
    	</tr>
    	<?php $i++;}}?>
