...
<div class="shop_select_box">
	...
	<div class="shop_more_one">
		<div class="shop_more_one_l">退货单：</div>
			<input type="text"  name="" readonly id="form_sn" value="<?php echo $baseform->form_sn?>"   class="form-control con_tel"   >
	...
	<div class="shop_more_one">
		<div class="shop_more_one_l">退货日期：</div>
			<input type="text"  name="CommonForms[form_time]" readonly id="form_time" value="<?php echo $baseform->form_time?$baseform->form_time:'';?>"  class="form-control   " placeholder=""  >
	</div>
	<div class="shop_more_one">
		<div class="shop_more_one_l">入库日期：</div>
		<input type="text"  name="FrmInput[input_date]"  id="input_date" value="<?php echo date('Y-m-d',time())?>"  class="form-control  date input_backimg" placeholder="选择日期"  >
	</div>
	<div class="shop_more_one">
...
<input type="hidden" id="tr_num" value="1">
    ...
    <tbody class="forinsert" id="forinsert">
    	...
    	<tr class="<?php echo $i%2==0?"selected":""?>">
			...
			<td>
				<input type="text"  name="" readonly style="" value="<?php echo $data->return_amount-$data->input_amount;?>" class="form-control  "  >
			</td>			
    		<td >
    			<input type="text"  name="td_amount[]" style="" value="<?php echo $data->return_amount-$data->input_amount;?>" class="form-control td_amount td_num"  >
    			<input type="hidden"   value="<?php echo $data->return_amount-$data->input_amount;?>" class="form-control  td_max_num"  >
    		</td>
    		<td >
    			<input type="text"  name=""  value="<?php echo round($data->return_weight-$data->input_weight,3);?>" style="" class="form-control td_weight" >
    			<input type="hidden"  name="td_weight[]"  value="<?php echo $data->return_weight-$data->input_weight;?>" style="" class="form-control  td_total_weight" >
    		</td>
    		<td ><input type="text"   name="td_price[]" readonly style="" value="<?php echo $data->return_price;?>"  class="form-control td_price" ></td>
    	</tr>
    	<?php $i++;}}?>
...
// 		if(td_price == ''||!/^[0-9]+(.[0-9]{1,2})?$/.test(td_price)){confirmDialog("请确认成本单价正确且为整数或2位小数点的小数");$(this).find(".td_price").addClass('red-border');flag= false;return false;}
	})
	if(!flag){return false;}
	if(can_submit){
        can_submit = false;
