...
<table class="detail_table">
	<tbody>
		...
		<tr>
			...
			<td class="detail_table_backg" style="width:13%;">入库日期</td><td style="width:20.3%;"><?php echo ($input->input_date>943891200)?date('Y-m-d',$input->input_date):'';?></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="detail_table_backg" style="width:13%;">最后更新时间</td><td style="width:20.3%;"><?php echo $baseform->last_update>12010?date('Y-m-d H:i:s',$baseform->last_update):'';?></td>
...
<div class="btn_list">
	<a href="<?php echo Yii::app()->createUrl('input/index',array('page'=>$fpage,'search_url'=>$_REQUEST['search_url']))?>">
