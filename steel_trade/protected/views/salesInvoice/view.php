...
<table class="detail_table">
	<tbody>
		<tr>
			<td class="detail_table_backg">收票单位</td><td><span title="<?php echo $model->company->name;?>"><?php echo $model->company->name;?></span></td>
			<td class="detail_table_backg">开票单位</td><td><span title="<?php echo $model->title->name;?>"><?php echo $model->title->short_name;?></span></td>
			<td class="detail_table_backg">开票重量</td><td><?php echo number_format($model->weight, 3);?>吨</td>
		</tr>
		<tr>
			...
			<td class="detail_table_backg">开票金额</td><td><?php echo number_format($model->fee, 2);?>元</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="detail_table_backg">客户</td><td><span title="<?php echo $model->client->name;?>"><?php echo $model->client->name;?></span></td>
	...
	<table id="cght_tb" class="table" style="display: none;">
		<thead>
			<tr>
				...
				<th class="flex-col text-right" style="width: 120px;">开票重量</th>
				<th class="flex-col text-right" style="width: 120px;">开票金额</th>
				<th class="flex-col text-right" style="width: 120px;">可开票重量</th>
				<th class="flex-col text-right" style="width: 120px;">可开票金额</th>
		...
		<?php if ($details) { 
			...
			<tr>
				...
				<td class="flex-col" style="width: 260px;"><?php echo $item->type != 'rebate' ? $item->brand.'/'.$item->product_name.'/'.str_replace('E', '<span class="red">E</span>', $item->texture).'/'.$item->rank.'/'.$item->length : '';?></td>
				...
				<td class="flex-col" style="width: 150px;"><span title="<?php echo $item->client->name;?>"><?php echo $item->client->name;?></span></td>
