...
<div class="search_body">
	...
	<div class="shop_more_one1 short_shop_more_one">
		...
		<div class="search_date_box">
			<input id="bak_date" type="text" class="form-control forreset date_end" placeholder="选择日期" value="<?php echo !empty($search['bak_date']) ? $search['bak_date'] : ''; ?>" name="search[bak_date]">
		</div>
	</div>
	<div class="shop_more_one1 short_shop_more_one">
	...
	<div class="more_select_box" style="">
	<div class="more_one">
	...
	<div class="more_one">
		<div class="more_one_l">剩余件数：</div>
		 <select name="search[left]" class='form-control chosen-select forreset'>
	            <option value='0' selected='selected'>-全部-</option>
	            <option <?php echo 2==$search['left']?'selected="selected"':''?> value="2">0</option>
            	<option <?php echo 1==$search['left']?'selected="selected"':''?> value="1">非0</option>            	
	        </select>
	</div>
</div>
</div>
...
<?php paginate($pages,"stoagelock_list");?>
<script>
$(function(){
