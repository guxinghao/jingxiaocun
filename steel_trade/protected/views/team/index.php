<div class="con_tit">
	...
	<div class="con_tit_cz">
		<a href="<?php echo Yii::app()->createUrl('team/create',array('page'=>$_REQUEST['page']))?>">
		<button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">新建业务组</button>
		</a>
	</div>
</div>
...
<div class="search_body">
	<div class="srarch_box">
		...
		<input placeholder="请输入名称" id="srarch" class="forreset" value="<?php echo $search->name?>" name="Team[name]">
	</div>
	...
	<table cellspacing="1" align="center" id="datatable1" class="table datatable" >
		<thead>
			<tr class="data">
				...
				<th width="500" class='table_cell_last'>业务组名称</th>
		...
		<tbody>
			<?php $i=0;
				foreach ($items as $item){
					$edit_url = Yii::app()->createUrl('team/update',array('id'=>$item->id,'page'=>$_REQUEST['page']));
			?>
...
<?php paginate($pages,"ywz")?>
<script>
	$(function(){
		$(".del_user").click(function(){
			var item = this;
			confirmDialogWithCallBack("确定要删除吗",function(){
				$.post("<?php echo Yii::app()->createUrl('team/delete')?>", {
