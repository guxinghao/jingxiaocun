...
<div class="con_tit">
	...
	<div class="con_tit_cz">
		<a href="<?php echo Yii::app()->createUrl('task/create',array('page'=>$_REQUEST['page']))?>">
		<button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">新建任务</button>
		</a>
	</div>
</div>
...
<div class="search_body">
	<div class="srarch_box">
		...
		<input placeholder="请输入任务名" class="forreset" value="<?php echo $search->name?>" name="AuthItem[name]" id="AuthItem_name">
	</div>
	...
	<table  cellspacing="1" align="center" id="datatable1" class="table datatable" >
		...
		<?php $i=0;
			foreach ($auths as $item){
				$edit_url = Yii::app()->createUrl('task/update',array('name'=>$item->name,'page'=>$_REQUEST['page']));
		?>
