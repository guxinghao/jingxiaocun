<?php 
	setcookie('purchase_view','indexForStore',time()+60*60*24,'/');
?>
<div class="con_tit">
...
<?php }?>
	...
	<?php 
		if(checkOperation("采购普通视图")){$left='no';}
		$num = 0;
	...
	<?php }?>
		...
		<div class="<?php 
		if($num==0){
			if($left=='no')echo 'view_button_right';			
		}else{
			if($left=='no'){
				echo 'view_button_middle';
			}else{echo 'view_button_left';}
		}
		?> blue_back view_button" title="配送视图">
			<img alt=""  class="view_button_img"  src="/images/middle_blue1.png">
		</div>
...
<form method="post" action="/index.php/purchase/indexForStore?page=1" url="">
