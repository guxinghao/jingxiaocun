<?php 
	setcookie('purchase_view','indexForCheck',time()+60*60*24,'/');
?>
<div class="con_tit">
...
<?php }?>
	...
	<div class="view_section">
		<div class="view_button_right blue_back view_button" title="审核视图">
			<img alt="" class="view_button_img" src="/images/right_blue1.png">
		</div>
		<?php 
		$num=0;
		if(checkOperation("采购配送视图")){ 
		$num ++;
		if(checkOperation("采购普通视图")){$middle='yes';};
		?>
		<img alt="" class="view_section_img" src="/images/view_sep.png">
		<a href="<?php echo Yii::app()->createUrl('purchase/indexForStore')?>">
		<div class="<?php echo $middle=='yes'?'view_button_middle':'view_button_left';?> view_button" title="配送视图">
			<img alt=""  class="view_button_img"  src="/images/middle_white1.png">
		</div>
		</a>
		<?php }?>
		<?php if(checkOperation("采购普通视图")){
			$num++;
		?>
		<img alt="" class="view_section_img" src="/images/view_sep.png">
		<a href="<?php echo Yii::app()->createUrl('purchase/index',array('exact'=>'yes'))?>">
		<div class="view_button_left  view_button"  title="采购视图">
			<img alt="" class="view_button_img" src="/images/left_white1.png">
		</div>
		</a>
		<?php  }if($num==0){?>
		<script>
...
<form method="post" action="/index.php/purchase/indexForCheck?page=1" url="">
