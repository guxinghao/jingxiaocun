		...
		<div class="print_body">
			...
			<div class="print_main">
				...
				<ul class="print_row list">
					...
					<?php  if($model->weight_confirm_status == 1){?>
					<li style="width: 64px;"><?php echo $detail ? $detail->fix_amount : '';?></li>
					<li style="width: 68px;"><?php echo $detail ? number_format($detail->fix_weight, 3) : '';?></li>
					<li style="width: 76px;"><?php echo $detail ? number_format($detail->fix_price, 2) : '';?></li>
					<li style="width: 113px;"><?php echo $detail ? number_format($detail->fix_weight * $detail->fix_price, 2) : '';?></li>
					<li style="width: 181px;"><?php echo $detail ? $model->transfer_number : '';?></li>
					<?php }else{?>
					...
					<li style="width: 113px;"><?php echo $detail ? number_format($detail->weight * $detail->price, 2) : '';?></li>
					<li style="width: 181px;"><?php echo $detail ? $model->transfer_number : '';?></li>
					<?php }?>
				</ul>
				<?php 
					if($model->weight_confirm_status == 1){
						$total_amount += $detail ? $detail->fix_weight * $detail->fix_price : 0;
						$t_weight += $detail->fix_weight;
					}else{
						$total_amount += $detail ? $detail->weight * $detail->price : 0;
			...
			<div class="print_foot" style="margin-top:-3px;">
				<ul class="print_row" >
					...
					<li style="width: 300px; text-indent: 40px;font-size:30px;"><?php echo $model->is_yidan==1?"***":"";?></li>
				</ul>
			</div>
		</div>
	</body>
