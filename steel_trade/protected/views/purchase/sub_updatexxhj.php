...
<div class="shop_select_box">
	...
	<div class="shop_more_one">
		...
		<div class="search_date_box" style="margin-top:0px;background-position:155px 8px;">
			<input type="text"  name="CommonForms[form_time]" readonly value="<?php echo $baseform->form_time?>" class="form-control  input_backimg" placeholder="选择日期"  >
		</div>
	</div>
<!-- 	<div class="shop_more_one"> -->
...
<!-- 		</div> -->
	...
	<div class="shop_more_one " >
		...
		<input type="text" readonly name="FrmPurchase[shipment]" value="<?php echo $purchase->shipment?>" id="shipment" style="width:145px;height:33px;" class="form-control " placeholder=""  >
...
<input type="hidden" id="tr_num" value="<?php echo count($details)?>">
    ...
    <tbody class="forinsert" id="forinsert">
    	...
    	<tr class="<?php echo $i%2==0?'selected':''?>">
    		...
    		<td class="">
					<input type="text" readonly id="<?php echo "bbcombobrand".$i?>"   value="<?php echo DictGoodsProperty::getProName($each->brand_id)?>" class="form-control"/>
