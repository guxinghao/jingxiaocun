...
<div class="shop_select_box">
		...
		<div class="shop_more_one_l supply_div">托盘公司：</div>
		 <select name="" id="pledge_company" disabled class='form-control chosen-select se_yw'>
			 ...
			 <?php if(!empty($tpcompanys)){ foreach($tpcompanys as $k=>$v){?>
			   	<option <?php echo $frmPledge->company_id==$k?'selected="selected"':''?> value='<?php echo $k;?>'><?php echo $v;?></option>
			  <?php }}?>
	   	 </select>
		<input type="hidden" name="FrmPledgeRedeem[company_id]" class="pledge_company" value="<?php echo $frmPledge->company_id?>">
	</div>
	<div class="shop_more_one">
		...
		<select name="" id="title_id" disabled class='form-control chosen-select se_yw'>
			 ...
			 <?php if(!empty($titles)){foreach($titles as $k=>$v){?>
			   	<option <?php echo $frmPledge->title_id==$k?'selected="selected"':''?> value='<?php echo $k;?>'><?php echo $v;?></option>
			  <?php }}?>
	   	 </select>
	   	 <input type="hidden" name="FrmPledgeRedeem[title_id]" class="title_id" value="<?php echo $frmPledge->title_id?>">
	</div>
	<div class="shop_more_one">
		<div class="shop_more_one_l">采购单：</div>
		<input type="text"  readonly id="form_sn"  name="" class="form-control " value="<?php echo $purchase->baseform->form_sn?>" placeholder=""  >
		<input type="hidden" name="FrmPledgeRedeem[purchase_id]" value="<?php echo $purchase->id?>">
	</div>
	<div class="shop_more_one">
		<div class="shop_more_one_l">托盘赎回等级：</div>
		<input type="text"  name="" readonly class="form-control " id="r_limit_name" value="" placeholder="" >
	...
	<div class="shop_more_one" >
		...
		<div class="search_date_box">
			<input type="text"  name="CommonForms[form_time]" id="date_now" value="<?php echo $baseform->form_time;?>" class="form-control form-date date input_backimg" placeholder="选择日期"  >
		</div>
	</div>
	<div class="shop_more_one">
...
// 	var interest=tp_price*td_weight-buy_price*(td_weight/td_tpweight);
...
/**----------------托盘采购列表》》-------------***/
 var selected_sales='<?php echo $frmPledge->purchase->baseform->id?>';
$(function(){
	...
	var old_brand='<?php echo $frmPledge->brand_id;?>';
	var old_product='<?php echo $frmPledge->product_id?>';
	var old_weight='<?php echo $frmPledge->weight;?>';
	var old_total_fee='<?php echo $frmPledge->total_fee;?>';
	var old_interest='<?php echo $frmPledge->interest_fee?>';
	$('.td_brand').val(old_brand);
	$('.td_brand').trigger('change');
	if(old_product)
	{
		$('.td_product').val(old_product);
		$('.td_product').trigger('change');
	}
	$('.td_weight').val(formatNum(old_weight));
	$('.td_money').val(formatNum(old_total_fee));
	$('.td_interest_fee').val(formatNum(old_interest));
});
