...
<div class="shop_select_box">
	...
	<div class="shop_more_one">
		...
		<input type="text"  readonly name="CommonForms[form_time]" value="<?php echo $baseform->form_time;?>"  class="form-control  create_time " placeholder="请选择日期"  >
	</div>
<!-- 	<div class="shop_more_one"> -->
...
<input type="hidden" id="tr_num" value="1">
	<table class="table"  id="cght_tb" >
    	<thead>
     		<tr>
         		...
         		<th class="text-center" style="width:8%;">品名</th>
         		...
         		<th class="text-center" style="width:6%;">可入库件数</th>
    ...
    <tbody class="forinsert" id="forinsert">
    	...
    	<tr class="<?php echo $i%2==0?"selected":""?>">
    		...
    		<td >
    			<input type="text"  name="td_remain_amount[]" style=""  value="<?php echo $data->remain_amount;?>" class="form-control  td_remain_num" >
    		</td>
    		<td >
    			<input type="text"  name="td_remain_weight[]" style=""  value="<?php echo round($data->remain_weight,3);?>" class="form-control  td_remain_weight" >
    		</td>
    		<td ><input type="text"  name="td_price[]" readonly style="" value="<?php echo $data->cost_price;?>" class="form-control td_price" ></td>
    	</tr>
    	<?php $i++;}}?>
