...
<div class="shop_select_box">
	<div class="shop_more_one">
		...
		<input type="hidden"  name="FrmInput[from]" value="storage" id="from">
		<input type="hidden"  name="FrmInput[input_status]" value="0" id="input_status">
		<input type="hidden"  name="FrmInput[push_id]" value="<?php echo $push_id?>" id="push_id">
	...
	<div class="shop_more_one">
		<div class="shop_more_one_l">采购单：</div>
			<input type="text"  name="" id="form_sn" value="<?php echo $baseform->form_sn?>"   class="form-control con_tel"   >
	...
	<div class="shop_more_one">
		...
		<div class="search_date_box"  >
			<input type="text"  name=""  id="" value="<?php echo $baseform->form_time?$baseform->form_time:date('Y-m-d',time());?>"  class="form-control date  input_backimg" placeholder="选择日期"  >
		</div>
	</div>
	<div class="shop_more_one">
		<div class="shop_more_one_l">入库日期：</div>
		<div class="search_date_box"  >
			<input type="text"  name="FrmInput[input_date]"  id="input_date" value="<?php echo ($storage->created_at>943891200)?date('Y-m-d',$storage->created_at):date('Y-m-d',time());?>"  class="form-control date input_backimg " placeholder="选择日期"  >
		</div>
	</div>
	<div class="shop_more_one">
	...
	<div class="shop_more_one">
		...
		<input type="text"  name="CommonForms[form_time]" value="<?php echo date('Y-m-d',time());?>"  class="form-control date create_time input_backimg" placeholder="请选择日期"  >
	</div>
<!-- 	<div class="shop_more_one">  -->
<!-- 		<div class="shop_more_one_l">是否船舱：</div> -->
<!-- 		<input class="check_box l"  type="checkbox" name="FrmInput[is_cc]" value="1" /><div class="lab_check_box">船舱入库</div> -->
<!-- 	</div> -->
</div>
    ...
    <tbody class="forinsert" id="forinsert">
    	...
    	<tr class="<?php echo $i%2==0?"selected":""?>">
    		...
    		<td class="">
    			...
    			<input type="hidden" name="td_plan_id[]" value="<?php echo $data->original_detail_id;?>">
			...
			<td><input type="text" name="td_card_id[]"  value="<?php echo $data->card_no?>" class="form-control td_card"></td>
    		<td ><input type="text"  name="td_amount[]" style="" value="<?php echo $data->amount;?>" class="form-control td_amount td_num"  ></td>
    		<td >
    			<input type="text"  name=""  value="<?php echo round($data->weight,3);?>" style="" class="form-control td_weight" >
    			<input type="hidden"  name="td_weight[]"  value="<?php echo $data->weight;?>" style="" class="form-control  td_total_weight" >
    		</td>
