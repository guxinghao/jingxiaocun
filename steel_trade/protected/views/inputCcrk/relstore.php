...
<div class="shop_select_box">
	...
	<div class="shop_more_one">
		...
		<div class="search_date_box"  >
			<input type="text"  name="FrmInput[input_date]"  value="<?php echo date('Y-m-d',time());?>" id="input_date"  class="form-control date input_backimg"  >
		</div>
	</div>
	<div class="shop_more_one">
	...
	<div class="shop_more_one"> 
		...
		<input class="check_box l"  disabled type="checkbox" <?php echo $input->input_type=="ccrk"?'checked="checked"':''?> name="FrmInput[is_cc]" value="1" /><div class="lab_check_box">船舱入库</div>
	</div>
</div>
...
<input type="hidden" id="tr_num" value="1">
    ...
    <tbody class="forinsert" id="forinsert">
    	...
    	<tr class="<?php echo $i%2==0?"selected":""?>">
    		...
    		<td >
    			<input type="text"  name="td_price[]" style="" value="<?php echo $data->cost_price;?>" class="form-control td_price" >
    			<input type="hidden" name="td_indet_id[]" value="<?php echo $data->id;?>"  class="td_id">
    		</td>
    	</tr>
    	<?php $i++;}}?>
    </tbody>
