...
<div class="shop_select_box">
	<div class="shop_more_one">
		...
		<input type="hidden"  name="FrmInput[input_type]" value="ccrk" id="input_type">
		...
		<div class="shop_more_one_l maybe_bitian1"><span class="bitian">*</span>预计到货时段：</div>
		 <select name="FrmInput[input_time]" class='form-control input_time'>
	            <option value='0' selected='selected'></option>	             
           		 <option <?php echo $input->input_time=='6'?'selected="selected"':''?>  value="6">00:00-06:00</option>
           		 <option  <?php echo $input->input_time=='12'?'selected="selected"':''?> value="12">06:00-12:00</option>
           		 <option  <?php echo $input->input_time=='18'?'selected="selected"':''?> value="18">12:00-18:00</option>
           		 <option  <?php echo $input->input_time=='24'?'selected="selected"':''?>  value="24">18:00-24:00</option>            	
	        </select>
	</div>
	<div class="shop_more_one">
...
<!-- 		 <select name="FrmInput[goods_status]" class="form-control"  id="goods_status"> --
	            <option value="1" <?php  //echo $input->goods_status==1?'selected="selected"':''?>>在厂里等装货</option>	             
           		 <option  value="2" <?php //echo $input->goods_status==2?'selected="selected"':''?>>在厂里在装货</option>          		             	
<!-- 	        </select> -->
<!-- 	</div> -->
	<div class="shop_more_one">
		<div class="shop_more_one_l">备注：</div>
		<input type="text"  name="CommonForms[comment]" readonly value="<?php echo $baseform->comment;?>"  class="form-control tit_remark" placeholder=""  >
	</div>
	<div class="shop_more_one">
		<div class="shop_more_one_l">创建时间：</div>
		<input type="text"  name="CommonForms[form_time]" readonly value="<?php echo $baseform->form_time;?>"  class="form-control date " placeholder="请选择日期"  >
	</div>
<!-- 	<div class="shop_more_one">  -->
...
<input type="hidden" id="tr_num" value="1">
	<table class="table"  id="cght_tb" >
    	<thead>
     		<tr>
         		...
         		<th class="text-center" style="width:6%;">保留件数</th>
         		<th class="text-center" style="width:6%;">保留重量</th>
    ...
    <tbody class="forinsert" id="forinsert">
    	...
    	<tr class="<?php echo $i%2==0?"selected":""?>">
			...
			<td><input type="text" readonly name="td_card_id[]"  value="<?php echo $data->card_id?>" class="form-control td_card"></td>
    		<td >
    			<input type="text"  readonly name="td_amount[]" style="" value="<?php echo $data->input_amount;?>" class="form-control td_amount td_num"  >
    		...
    		<td >
    			<input type="text"  readonly name=""  value="<?php echo round($data->input_weight,3);?>" style="" class="form-control td_weight" >
    			<input type="hidden"  name="td_weight[]"  value="<?php echo $data->input_weight;?>" style="" class="form-control  td_total_weight" >
    		</td>
    		<td >
    			<input type="text"  name="td_remain_amount[]" readonly style=""  value="<?php echo $data->remain_amount;?>" class="form-control  td_remain_num" >
    		</td>
    		<td >
    			<input type="text"  name="td_remain_weight[]" readonly style=""  value="<?php echo round($data->remain_weight,3);?>" class="form-control  td_remain_weight" >
    		</td>
    		<td ><input type="text" readonly name="td_price[]" style="" value="<?php echo $data->cost_price;?>" class="form-control td_price" ></td>
    	</tr>
    	<?php $i++;}}?>
