...
<div class="con_tit">
	...
	<?php }else{?>
	<div class="con_tit_cz">
		<a href="<?php echo Yii::app()->createUrl('frmOutput/create');?>" style="text-decoration: none;">
			<button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">新建库存出库</button>
		</a>
	</div>
	<div class="con_tit_cz">
		<a href="<?php echo Yii::app()->createUrl('frmOutput/xscreate');?>" style="text-decoration: none;">
			<button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">先销后进出库</button>
		</a>
	</div>
	<div class="con_tit_cz">
		<a href="<?php echo Yii::app()->createUrl('frmOutput/dxcreate');?>" style="text-decoration: none;">
...
<div class="search_body">
	...
	<div class="shop_more_one1" style="width:200px;">
