...
<div class="ss_tt_title" style="border-bottom:1px dotted #b1b0b0;">
	<div class="shop_more_one" style="position:relative;margin:6px 40px 0 0;width:250px;">
		<div class="shop_more_one_l" style="width:75px;text-align:right;">退货单：</div>
			...
			<?php if(!$return){?>
			<span style="float: right;margin:-30px -18px 0 0;width:40px;font-size:15px;color:#fff;text-align:center;border:none;background:#1ca1e4;height:29px;line-height:29px;border-radius:4px;" class="contract_link colorbox" url="<?php echo Yii::app()->createUrl('frmPurchaseReturn/returnlist')?>">关联</span>
		...
		<thead>
			<tr>
				...
				<th class="text-center" style="width:15%;">卡号</th>
         		...
         		<th class="text-center" style="width:10%;">可退货件数</th>
         		<th class="text-center" style="width:10%;"><span class="bitian">*</span>退货件数</th>
         		<th class="text-center" style="width:10%;"><span class="bitian">*</span>退货重量</th>
			</tr>
		</thead>
		<tbody>
...
function getOutdetail(id){
	$.post("/index.php/frmOutput/rtdetaillist",{"id":id},function(data){
