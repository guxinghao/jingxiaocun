...
<table class="detail_table">
	<tbody>
		...
		<tr>
			...
			<td class="detail_table_backg" style="width:13%;">采购单</td><td style="width:20.3%;"><?php echo $basePurchase->form_sn?></td>			
			<td class="detail_table_backg" style="width:13%;">采购日期</td><td style="width:20.3%;"><?php echo $basePurchase->form_time;?></td>
		</tr>
		<tr>
			<td class="detail_table_backg" style="width:13%;">业务员</td><td style="width:20.3%;"><?php echo $basePurchase->belong->nickname;?></td>
			<td class="detail_table_backg" style="width:13%;">业务组</td><td style="width:20.3%;"><?php echo $purchase->team->name;?></td>
			<td class="detail_table_backg" style="width:13%;">预计到货日期</td><td style="width:20.3%;"><?php echo ($inputPlan->input_date>943891200)?date('Y-m-d',$inputPlan->input_date).' '.$_time[$inputPlan->input_time]:'';?></td>
		</tr>
		<tr>
			<td class="detail_table_backg" style="width:13%;">车船号</td>
			<td style="width:20.3%;">
			<?php 
				$authtext =$inputPlan->ship_no;
				...
				if(count($autharr) > 2){
					...
					echo $inputPlan->ship_no;
				}
			?>
			</td>			
			<td class="detail_table_backg" style="width:13%;">入库仓库</td><td style="width:20.3%;"><?php echo $purchase->warehouse->name;?></td>
			<td class="detail_table_backg" style="width:13%;">状态</td><td style="width:20.3%;"><span class="red"><?php echo $_status[$inputPlan->input_status];?></span></td>
		</tr>
		<tr>
			<td class="detail_table_backg" style="width:13%;">是否船舱</td><td style="width:20.3%;"><?php echo $inputPlan->input_type=="ccrk"?'是':'';?> </td>
