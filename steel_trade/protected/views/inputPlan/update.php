...
<div class="shop_select_box">
	...
	<div class="shop_more_one">
		...
		<div class="search_date_box" >
			<input type="text" readonly name=""  id="" value="<?php echo $basePurchase->form_time;?>"  class="form-control   " placeholder=""  >
		</div>
	</div>
	<div class="shop_more_one">
	...
	<div class="shop_more_one">
		...
		<input type="text"  name="CommonForms[form_time]" value="<?php echo $baseform->form_time;?>"  class="form-control date create_time input_backimg" placeholder="请选择日期"  >
	</div>
	<div class="shop_more_one"> 
		<div class="shop_more_one_l" style="padding-top:2px;">是否船舱：</div>
		<input class="check_box l is_cc" disabled type="checkbox" <?php echo $inputPlan->input_type=="ccrk"?'checked="checked"':'';?> name="FrmInput[is_cc]" value="1" /><div class="lab_check_box">船舱入库</div>
	</div>
</div>
...
<input type="hidden" id="tr_num" value="1">
	<table class="table"  id="cght_tb" >
    	<thead>
     		<tr>
         		...
         		<?php if($inputPlan->input_type=='ccrk'){?>
    ...
    <tbody class="forinsert" id="forinsert">
    	...
    	<!--  ->	<td class="text-center"><i class="icon icon-trash deleted_tr" style="line-height:26px;"></i></td>-->
    		...
    		<?php if($inputPlan->input_type=='ccrk'){?>
    		<td >
    			<input type="text"  name="td_remain_amount[]" style="" readonly value="<?php echo $data->remain_amount;?>" class="form-control  td_remain_num" >
    		</td>
    		<td >
    			<input type="text"  name="td_remain_weight[]" style="" readonly value="<?php echo $data->remain_weight;?>" class="form-control  td_remain_num" >
    		</td>
    		<?php }?>
    	</tr>
    	<?php $i++;}}?>
...
<!--     <button type="button" class="btn btn-primary btn-sm " data-dismiss="modal"  id="submit_btn1">保存推送</button> -->
	...
	<a href="<?php echo Yii::app()->createUrl('inputPlan/index')?>">
...
$("#submit_btn").click(function(){
	...
	var url='/index.php/inputPlan/update/'+id+'?fpage='+fpage;
