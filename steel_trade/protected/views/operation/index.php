...
<div class="con_tit">
	...
	<div class="con_tit_cz">
		<a href="<?php echo Yii::app()->createUrl('operation/create',array('page'=>$_REQUEST['page']))?>">
		<button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">新建操作</button>
		</a>
	</div>
</div>
...
<div class="search_body">
	<div class="srarch_box">
		...
		<input placeholder="请输入操作名" class="forreset" value="<?php echo $search->name?>" name="AuthItem[name]" id="AuthItem_name">
	</div>
	...
	<table  cellspacing="1" align="center" id="datatable1" class="table datatable" >
		...
		<?php $i=0;
			foreach ($auths as $item){
				$edit_url = Yii::app()->createUrl('operation/update',array('name'=>$item->name,'page'=>$_REQUEST['page']));
		?>
		<tr class="" id="<?php echo $item->name?>">
			<td style="text-align: center;" class="table_cell_first">
