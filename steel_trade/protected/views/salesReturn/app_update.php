...
<div class="shop_select_box">
	...
	<div class="shop_more_one">
		...
		<select name="FrmSalesReturn[contact_id]" disabled class='form-control chosen-select se_ywz' id="contact_id">
				<option value=""></option>
	     </select>
	</div>
	<div class="shop_more_one">
	...
	<div class="shop_more_one">
		...
		<input type="text"  name="FrmSalesReturn[travel]" class="form-control transfer" readonly value="<?php echo $salesReturn->travel;?>" placeholder=""  >
	</div>
	<div class="shop_more_one">
