...
<?php if($baseform->form_status == "unsubmit") {?>
	...
	<div class="shop_more_one">
		...
		<input type="text"  class="form-control tit_remark" name="FrmSales[comment]" value="<?php echo htmlspecialchars($sales->comment);?>">
	</div>
	<?php }else{?>
	<div class="shop_more_one">
		<div class="shop_more_one_l"><span class="bitian">*</span>公司：</div>
...
<div class="create_table">
    ...
    <?php 
    	...
    	$toatl_amount += $dt->amount;
    	$toatl_weight += $dt->weight;
    	$toatl_price += $dt->fee;
    ?>
    	<tr class="">
    		<input type="hidden" name="details_id[]" value="<?php echo $dt->id;?>">
    		<input type="hidden" class="td_warehouse_id" value="<?php echo $dt->mergestorage->warehouse_id;?>">
    		<input type="hidden" class="td_title_id" value="<?php echo $sales->title_id;?>">
    		<input type="hidden" class="td_card_id" value="<?php echo $dt->card_id;?>" name="card_id[]">
    	...
    	<!--<td class=""><input type="text"  style="" class="form-control can_num" placeholder="" name="can_num[]" readonly></td>
    		...
    		<td class=""><input type="text"  style="" readonly  class="form-control td_price"  name="price[]" value="<?php if($dt->fee>0){ echo number_format($dt->fee,2);}else{ echo number_format($dt->amount*($dt->price),2);}?>" <?php if($baseform->form_status != "unsubmit" && !$super) echo "readonly";?>></td>
	    ...
	    <tfoot>
    		<tr class="tablefoot">
				...
				<?php }else{?>
				<td class="text-center" style="width:7%;">合计：</td>
				<?php }?>
				<td style="width:8%;"></td>
				<td style="width:6%;"></td>
				<td style="width:7%;"></td>
				...
				<td style="width:5%;"></td>
				<td style="width:7%;"></td>
				<td style="width:7%;"><span class="total_amount"><?php echo $toatl_amount;?></span></td>
				<td style="width:10%;"><span class="total_weight"><?php echo $toatl_weight;?></span></td>
