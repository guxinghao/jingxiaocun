...
<div class="shop_select_box">
	<div class="shop_more_one">
		<div class="shop_more_one_l"><span class="bitian">*</span>区域名称：</div>
		<input type="text"  id="name" name="WareArea[name]" style="width:150px;height:33px;" value="<?php echo $model->name;?>" class="form-control "   >
	</div>
...
<script>
	$(function(){	
		...
		$(".cancel").click(function(){
			location.href="<?php echo Yii::app()->createUrl('area/index')?>";
		});
