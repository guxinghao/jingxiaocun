...
<?php if (checkOperation("导出")) {?>
	<div class="con_tit_daoru btn_export" url="<?php echo Yii::app()->createUrl('turnover/totalExport_aa');?>">
	...
	<table id="datatable1" cellspacing="1" align="center" class="table datatable" style="display: none">
		<thead>
			<tr class="data">
				...
				<!-- <th width="110" class="leftAlign">公司抬头</th> -->
				...
				<th width="100" class="flex-col rightAlign">收款登记</th>
				<th width="110" class="flex-col rightAlign">仓库返利</th>
		...
		<?php $i = 1; foreach($items as $item) {
			...
			?>
			<tr class="data">
				<td class="table_cell_first text-center"><?php echo $i;?></td>
				<!-- <td>
