 ...
 * @property string $quoted_detail_id
 */
class WxQuotedData extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('product_std, texture_std, brand_std, rank_std, area, type, quoted_detail_id', 'length', 'max'=>45),
			array('price', 'length', 'max'=>11),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, product_std, texture_std, brand_std, rank_std, length, area, price, created_by, created_at, last_update, type, price_date, prefecture, send_id, quoted_detail_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'send_id' => 'Send',
			'quoted_detail_id' => 'Quoted Detail',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('quoted_detail_id',$this->quoted_detail_id,true);
