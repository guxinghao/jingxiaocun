...
class UserData extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('loginname, nickname, phone, last_login_ip, unid, number, invit_code', 'length', 'max'=>45),
			array('password', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, loginname, nickname, password, phone, created_at, last_login_at, last_login_ip, is_deleted, unid, team_id, priority, number, invit_code', 'safe', 'on'=>'search'),
		);
	}
