...
/**
 * This is the biz model class for table "payment_view".
 *
 */
class PaymentView extends PaymentViewData
{
	...
	public function relations()
	{
		...
		return array(
				'in_bank' => array(self::BELONGS_TO, 'DictBankInfo', 'bank_id'),
				'out_bank' => array(self::BELONGS_TO, 'DictBankInfo', 'out_bank_id'),
		);
	}
