...
/**
 * This is the model class for table "quoted_warehouse_relation".
 *
 * The followings are the available columns in table 'quoted_warehouse_relation':
 * @property integer $id
 ...
 */
class QuotedWarehouseRelationData extends CActiveRecord
{
	/**
	...
	{
		return 'quoted_warehouse_relation';
	}
