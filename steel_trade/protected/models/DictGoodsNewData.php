...
/**
 * This is the model class for table "dict_goods_new".
 *
 * The followings are the available columns in table 'dict_goods_new':
 * @property integer $id
 ...
 */
class DictGoodsNewData extends CActiveRecord
{
	/**
