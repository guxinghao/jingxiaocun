 ...
 *
 * The followings are the available columns in table 'business_view':
 ...
 */
class BusinessViewData extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('common_id, main_id, created_at, created_by, owned_by', 'numerical', 'integerOnly'=>true),
			array('amount', 'length', 'max'=>32),
			array('weight', 'length', 'max'=>37),
			array('fee', 'length', 'max'=>48),
			array('is_yidan, form_status', 'length', 'max'=>20),
			...
			array('common_id, main_id, amount, weight, fee, is_yidan, form_type, form_sn, created_at, created_by, created_by_nickname, form_time, form_status, owned_by, owned_by_nickname, customer_name, customer_short_name, title_name, comment', 'safe', 'on'=>'search'),
		);
	}
